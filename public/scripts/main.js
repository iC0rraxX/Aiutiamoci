...
var recapitoInput = document.getElementById('recapito');
var messageForm = document.getElementById('message-form');
var messageInput = document.getElementById('new-post-message');
var titleInput = document.getElementById('new-post-title');
var signInButton = document.getElementById('sign-in-button');
// var signInButtonTel = document.getElementById('sign-in-button-phone');
 ...
 */
// [START write_fan_out]
function writeNewPost(uid, username, picture, title, body, tel) {
  // A post entry.
  var postData = {
    author: username,
    uid: uid,
...
function addCommentElement(postElement, id, text, author) {
  ...
  comment.innerHTML = '<p><span class="username" style="font-weight:bold"></span>: <span class="comment"></span></p>';
  ...
  var fetchPosts = function(postsRef, sectionElement) {
    postsRef.on('child_added', function(data) {
      ...
      containerElement.insertBefore(
        createPostElement(data.key, data.val().title, data.val().body, data.val().tel, author, data.val().uid, data.val().authorPic),
 ...
 */
function newPostForCurrentUser(title, text, tel) {
...
window.addEventListener('load', function() {
  ...
  messageForm.onsubmit = function(e) {
    ...
    var tel = recapitoInput.value;
    var title = titleInput.value;
    if (text && title) {
      newPostForCurrentUser(title, text, tel).then(function() {
